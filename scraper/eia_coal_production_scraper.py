...
BASE_URL = "https://www.eia.gov/international/data/country/{code}/coal-and-coke/coal-and-coke-production"
...
def main():
    print("=" * 60)
    print("EIA ASEAN Coal Production Scraper")
    print("=" * 60)
    ...
    output = {
        ...
        "source": "eia.gov",
        "description": "Coal production data for Southeast Asian countries (1980-2024)",
        "summary": {
